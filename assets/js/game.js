...
var fight = function(enemy) {
  while(playerInfo.health > 0 && enemy.health > 0) {
    ...
    if (promptFight === "skip" || promptFight === "SKIP" || promptFight === "S" || promptFight === "s") {
...
// random number generator called when a min/max attribute is needed (like attack or health)
